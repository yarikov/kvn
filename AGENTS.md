...
| `migrations` | `src/migrations.rs`, `contrib/migrations/*.sh` | Ordered transactional package migrations, candidate config and backups, per-user/machine markers, AUR updater, daemon/VPN handoff |
